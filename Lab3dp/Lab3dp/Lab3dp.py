...
class Enrollment:
    @staticmethod
    def enroll( student: Student, course,):
        student.courses.append(course)        
        print(f'Student {student.name} has been added to the course {course.title}')
        return f'Student {student.name} has been added to the course {course.title}'

    @staticmethod
    def unenroll(  student:Student, course:Course):
        """Remove students from the course and course title from students courses"""
        student.courses.remove(course)
        print(f'{student.name} has been removed from course {course.title}')
